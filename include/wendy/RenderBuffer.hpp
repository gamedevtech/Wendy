...
protected:
  Buffer(RenderContext& context, uint target);
private:
...
public:
   ...
   *  @return The newly created buffer, or @c nullptr if an error occurred.
   */
  static VertexBuffer* create(RenderContext& context, size_t size, BufferUsage usage);
private:
...
public:
   ...
   *  @return The newly created buffer, or @c nullptr if an error occurred.
   */
  static IndexBuffer* create(RenderContext& context, size_t size, BufferUsage usage);
private:
